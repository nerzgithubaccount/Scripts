...
finity.dark_theme = { -- dark
	...
	separator_color = Color3.fromRGB(67, 148, 103),

	text_color = Color3.fromRGB(138, 138, 138),

	category_button_background = Color3.fromRGB(67, 148, 103),
	category_button_border = Color3.fromRGB(66, 110, 100),

	checkbox_checked = Color3.fromRGB(119, 224, 163),
	checkbox_outer = Color3.fromRGB(84, 81, 86),
	checkbox_inner = Color3.fromRGB(46, 46, 46),

	slider_color = Color3.fromRGB(67, 148, 103),
	slider_color_sliding = Color3.fromRGB(119, 224, 163),
	slider_background = Color3.fromRGB(88, 84, 90),
	slider_text = Color3.fromRGB(177, 177, 177),

	textbox_background = Color3.fromRGB(67, 148, 103),
	textbox_background_hover = Color3.fromRGB(143, 255, 193),
	textbox_text = Color3.fromRGB(195, 195, 195),
	textbox_text_hover = Color3.fromRGB(143, 255, 193),
	textbox_placeholder = Color3.fromRGB(135, 135, 138),

	dropdown_background = Color3.fromRGB(67, 148, 103),
	dropdown_text = Color3.fromRGB(195, 195, 195),
	dropdown_text_hover = Color3.fromRGB(143, 255, 193),
	dropdown_scrollbar_color = Color3.fromRGB(143, 255, 193),
	...
	scrollbar_color = Color3.fromRGB(67, 148, 103),
}
